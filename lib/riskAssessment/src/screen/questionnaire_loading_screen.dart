...
class _SuggestionLoadingScreenState extends State<SuggestionLoadingScreen> with TickerProviderStateMixin {
  ...
  // Updated loading texts to match the health assessment context
  List<String> loadingTexts = [
    'Analyzing your health profile',
    'Evaluating your medical history',
    'Assessing the risk factors',
    'Generating personalized recommendations',
    'Preparing your tailored health roadmap',
  ];
  ...
  void initState() {
    ...
    // Start changing the loading texts periodically
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            // Animated health icon with pulsating effect
            AnimatedBuilder(
            ...
            Padding(
              ...
              child: Text(
                "We're working on tailoring your health test. This may take a moment. Thank you for your patience!",
                style: TextStyle(
                  fontSize: 16,
